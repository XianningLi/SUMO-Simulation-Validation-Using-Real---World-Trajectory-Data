...
traci.start('sumo-gui -c ./NGSIMTest.sumocfg --start');

% Open a file for writing
fileID = fopen('NGSIMTest.rou.xml', 'w');

% Write the XML content to the file
fprintf(fileID, '<routes>\n');
fprintf(fileID, '<vType id="auto" accel="3.8" decel="3.8" length="4.4" width="1.5" minGap="1" maxSpeed="12" guiShape="passenger" color="1,0,0"/>\n');
fprintf(fileID, '<vType id="human" accel="3.8" decel="3.8" length="4.4" width="1.5" minGap="1" maxSpeed="12" guiShape="passenger" color="0,0,1"/>\n');
fprintf(fileID, '<route id="right" edges="AB"/>\n');

% Writing individual vehicle details
fprintf(fileID, '<vehicle id="AV" type="auto" route="right" depart="0" departSpeed="4.572" departLane="1" departPos="51.5285736" />\n');
fprintf(fileID, '<vehicle id="FC" type="human" route="right" depart="0" departSpeed="3.599688" departLane="1" departPos="35.4049584" />\n');
fprintf(fileID, '<vehicle id="FT" type="human" route="right" depart="0" departSpeed="3.599688" departLane="0" departPos="21.8498928" />\n');
fprintf(fileID, '<vehicle id="LC" type="human" route="right" depart="0" departSpeed="3.048" departLane="0" departPos="63.5504952" />\n');
fprintf(fileID, '<vehicle id="LT" type="human" route="right" depart="0" departSpeed="4.559808" departLane="0" departPos="58.1765664" />\n');

% Close the routes tag and the file
fprintf(fileID, '</routes>\n');
fclose(fileID);
